...
<body>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <?php if (isset($_SESSION['APPLICANTID'])) {
                ...
                <a data-target="#myModal" data-toggle="modal" href="" style="font-size: 14px" ;> <i
                    class="fa fa-lock"></i> User Login </a>
                <span style="margin-left: 40px;"></span>
                <a href="http://localhost/career_guidance_portal/admin/login.php" style="font-size: 14px; target="
                  _blank"> <i class="fa fa-lock"></i> Admin Login </a>
              <?php } ?>
      ...
      <div class="navbar navbar-default navbar-static-top">
        <div class="container">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?php echo web_root; ?>index.php">Career Guidance</a>
          </div>
          <div class="navbar-collapse collapse ">
            <ul class="nav navbar-nav">
              <li class="<?php echo !isset($_GET['q']) ? 'active' : '' ?>"><a
                  href="<?php echo web_root; ?>index.php">Home</a></li>
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li class="<?php if (isset($_GET['q'])) {
                    ...
                    <a href="<?php echo web_root; ?>index.php?q=advancesearch">Advance Search</a>
                  </li>
              ...
              <li class="<?php if (isset($_GET['q'])) {
                ...
                <a href="<?php echo web_root; ?>index.php?q=company">Company</a>
              </li>
              <li class="<?php if (isset($_GET['q'])) {
                if ($_GET['q'] == 'hiring') {
                  echo 'active';
                ...
                <a href="<?php echo web_root; ?>index.php?q=hiring">Hiring Now</a>
              </li>
              <li class="<?php if (isset($_GET['q'])) {
                if ($_GET['q'] == 'About') {
                  echo 'active';
        ...
        <div id="sidebar" class="sidebar">
          ...
          <div class="sidebar-content">
            <div class="chat-container">
              ...
              <br>
              <br>
              <!-- <div class="submit" id="submit" onclick="sendMessage()">Submit</div> -->
              <button onclick="sendMessage()" class="submit">Submit</button>
            </div>
            <br>
            <br>
        ...
        <div class="main-content">
          <button class="open-btn" onclick="openSidebar()"><img src="robotss.png" alt=""></button>
          <!-- <h1>Main Content</h1>
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4">
            <div class="widget">
              ...
              <address>
                <strong>GOVT. Engineering College</strong><br>
                Tirunelveli<br>
              </address>
              <p>
                <i class="icon-phone"></i> (123) 456-789 - 1255-12584 <br>
                <i class="icon-envelope-alt"></i> Pavithra@gmail.com
              </p>
            </div>
          </div>
          <div class="col-md-4 col-sm-4">
  ...
  <script type="text/javascript" src="<?php echo web_root; ?>plugins/datepicker/bootstrap-datepicker.js"
